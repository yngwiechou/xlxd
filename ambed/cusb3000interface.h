...
//  Modified by Yngwie Chou (BU2EA) on 11/08/2017
//  Copyright © 2015 Jean-Luc Deltombe (LX3JL) and Yngwie Chou (BU2EA). All rights reserved.
//
// ----------------------------------------------------------------------------
...
public:
    // constructors
    CUsb3000Interface(uint32, uint32, const char *, const char *, int);
...
protected:
    ...
    // data
    uint8   m_uiChCodecs[USB3000_NB_CH];
};
